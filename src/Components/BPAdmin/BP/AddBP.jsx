...
export default function AddBP() {
    ...
    return (
        <div className="card flex justify-content-center">
            <Button label="Add BP'(s)" icon={PrimeIcons.PLUS} onClick={() => setVisible(true)} style={{ width: "150px", borderRadius: "7px" }} />
            <Dialog header="Add BP" visible={visible} style={{ width: '50vw' }} onHide={() => setVisible(false)} draggable={false} footer={footerContent}>
                <div className="mt-5">
                    <label htmlFor="bpId" class="col-form-label">BP ID</label>
                    <InputText id="bpId" type="number" value={bpId} onChange={(e) => {
                        handleChange(e, "id")
                        validateBPID();
                    }}
                ...
                <div className="mt-5 ">
                    <label htmlFor="bpName">BP Name</label>
                    <InputText id="bpName" type="text" value={bpName} onChange={(e) => {
                        handleChange(e, "name")
                        validateBpName();
                    }} onBlur={() => handleBlurValidation()} />
                    {!isValidBpName &&
                ...
                <div className="mt-5">
                    ...
                    <div>
                        <RadioButton inputId="PROD" name="PROD" value='PROD' onChange={(e) => handleChange(e, "system")} checked={system === 'PROD'} />
                        <label htmlFor="PROD" className="ml-2">PROD</label>
                    </div>
                    <div>
                        <RadioButton inputId="TEST" name="TEST" value='TEST' onChange={(e) => handleChange(e, "system")} checked={system === 'TEST'} />
