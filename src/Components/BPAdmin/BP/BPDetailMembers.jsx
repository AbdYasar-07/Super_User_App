...
const BPDetailMembers = () => {
    ...
    const [message, setMessage] = useState("Individually Unassign Users From This BP");
    ...
    return (
        <>
            <div style={{ marginTop: "30px", position: "relative", right: "465px" }}>
                <div style={{ display: "flex", justifyContent: "space-evenly", alignItems: "end", marginLeft: "100px" }}>
                    <SelectButton value={value} onChange={(e) => setValue(e.value)} optionLabel="name" options={items} />
                    {showOutBP && <Button style={{ borderRadius: "7px", position: "relative", left: "480px" }} label='Create Member'></Button>}
                </div>
